...
<head>
    ...
    *{box-sizing:border-box;}
    ...
    h3{color: white; text-align: center; font-weight:200;}
...
<form action = "" method = 'POST'>
  <h3>Welcome to our School Management System. Login to continue</h3>
    ...
    <a href="signUp.php" style="text-decoration:none; color:blue; display:block; text-align:center; margin-top:15px;">Don't have an account? Sign Up</a>
    <?php
    if (isset($_GET['error']) && $_GET['error'] === 'invalid'){
        echo"<p class='error'>Invalid creadentials.</p>";
    }
    ?>
    </fieldset>
</form>
